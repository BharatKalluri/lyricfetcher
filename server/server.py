"""The Sanic based API for lyricfetcher."""
...
async def helper(request):
    ...
    return text(
        ...
        [can be metro for metrolyrics or lyricswikia for lyricswikia] the
        second is the artist name, and the third is the song name.\n
